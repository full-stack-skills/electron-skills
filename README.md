...
**Electron desktop application development skills**

[![GitHub](https://img.shields.io/badge/github-full--stack--skills%2Felectron-skills-green.svg)](https://github.com/full-stack-skills/electron-skills)
...
**Electron Skills** is a curated collection of Agent Skills for AI coding agents, part of the [Full Stack Skills](https://github.com/partme-ai/full-stack-skills) ecosystem maintained by [PartMe.AI](https://github.com/partme-ai).
...
```bash
npx skills add full-stack-skills/electron-skills
```

Or install specific skills:

```bash
npx skills add full-stack-skills/electron-skills --skill <skill-name>
```
...
```bash
git clone https://github.com/full-stack-skills/electron-skills.git
cp -r electron-skills/skills/* .claude/skills/
```
